...
const Contact: React.FC = () => {
    ...
    const handleCopyEmail = (e: React.MouseEvent) => {
        e.preventDefault();
        navigator.clipboard.writeText('avinashgunturu.dev@gmail.com');
        setCopied(true);
        setTimeout(() => setCopied(false), 2000);
    };

    const socialLinks = [
        { icon: Github, label: 'GitHub', href: 'https://github.com/avinashGunturu', username: '@avinashGunturu' },
        { icon: Linkedin, label: 'LinkedIn', href: 'https://www.linkedin.com/in/avinash-gunturu-a972021a4/', username: '/in/avinash-gunturu' },
        { icon: Twitter, label: 'Twitter', href: 'https://x.com/GunturuAvinash', username: '@GunturuAvinash' },
    ];
                    ...
                    <div className="w-full max-w-lg relative overflow-hidden bg-[#09090b]/30 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-2xl">
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-gray-300 text-sm leading-relaxed">
                                Have a project in mind? I specialize in architecting scalable full-stack applications, robust payment integrations, and high-performance UI systems.
                            </p>
                        </div>
                        ...
                        <div className="bg-black/40 border border-white/10 rounded-xl p-1.5 flex items-center gap-2 mb-6 shadow-inner">
                            ...
                            <input
                                type="text"
                                readOnly
                                value="avinashgunturu.dev@gmail.com"
                        ...
                        <div className="mt-8 pt-6 border-t border-white/5 flex justify-between items-center">
                            ...
                            <a href="mailto:avinashgunturu.dev@gmail.com" className="text-xs text-white font-bold flex items-center gap-1 hover:text-brand-primary transition-colors">
